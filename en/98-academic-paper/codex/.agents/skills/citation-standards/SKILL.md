...
description: >-
  Trigger when: the task needs `citation-standards` guidance as a focused standalone step or as part of the `academic-paper` harness. Do not trigger when: the user wants the full `academic-paper` pipeline or an unrelated task outside this skill's domain. Expected input: brief, draft, issue, or source material. Expected output: domain-specific guidance, patterns, checks, or revisions.
---
...
## Paper Structure Standard (IMRaD)

| Section | Content | Tense |
|---------|---------|-------|
| **I**ntroduction | Background, prior literature, research questions | Present/Past |
| **M**ethods | Research design, participants, procedure, analysis | Past |
| **R**esults | Findings, statistical results | Past |
| **D**iscussion | Interpretation, limitations, implications | Present/Past |

### Statistical Results Reporting Standards (APA)
...
- [ ] Review journal Author Guidelines
- [ ] Word count compliance
- [ ] Citation style unified
- [ ] Reference list matches in-text citations
- [ ] Table/figure numbering in order
- [ ] Abstract word count (typically 150-300)
- [ ] Keywords 5-7 items
- [ ] Remove author information for blind review
